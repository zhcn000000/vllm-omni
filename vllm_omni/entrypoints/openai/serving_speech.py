...
class OmniOpenAIServingSpeech(OpenAIServing, AudioMixin):
    ...
    async def _prepare_speech_generation(
        ...
        return generator, tts_params

    async def _iter_pcm_audio_bytes(self, request: OpenAICreateSpeechRequest, request_id: str):
    ...
    async def create_speech(
        ...
        try:
            ...
            audio_bytes, media_type = await self._generate_audio_bytes(request, request_id)
